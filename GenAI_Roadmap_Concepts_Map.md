...
|----|-------|-----------------|------|
| **1** | Understanding LLMs From the Inside Out | How LLMs actually work — tokens, attention, generation — the mental model everything else builds on | ✅ [Understanding_LLMs_From_The_Inside_Out](https://github.com/JoshithReddyAleti/Understanding_LLMs_From_The_Inside_Out) |
| **2** | Python for AI — What Actually Matters | The Python that matters for AI engineering, cutting the 90% you don't need | ✅ [Python_For_AI_What_Actually_Matters](https://github.com/JoshithReddyAleti/Python_For_AI_What_Actually_Matters) |
| **3** | Building an AI Project — Blueprint for Beginners | The blueprint for structuring a real AI project from zero | ✅ [Building_AI_Project-Blueprint_for_Begin](https://github.com/JoshithReddyAleti/Building_AI_Project-Blueprint_for_Begin) |
| **4** | Your First End-to-End AI Project | Memory, tests & shipping — taking a project from notebook to shipped product | ✅ [Episode_4_Your_First_End_To_End_AI_Project](https://github.com/JoshithReddyAleti/Episode_4_Your_First_End_To_End_AI_Project) |

---

## Part II — The Core Stack
...
## Part IV — The Advanced & Discipline Layers
...
The AI Engineering Roadmap 2026 ends with the security capstone and hands off to the **Agentic AI Roadmap 2027** — from building AI to architecting autonomous agents. *(Its own repo — link to be added.)*

---

## 🙏 Acknowledgment

Every episode of this map carries the same dedication. **Srithu** is the reason it exists. If anyone wants to thank me for this work, everything goes for her.

---

*Pair each episode with its [Interview Prep counterpart →](../Interview_Prep/README.md)*
